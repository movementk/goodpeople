...
<body class="sub sponsor">
    ...
    <div class="page-intro">
        <div class="container">
            <div class="page-title">
                <h3>일시후원</h3>
                <p class="summary">
                	굿피플과 시작하는 작은나눔, 후원자분들의 마음이 모여 전세계 곳곳에 희망의 씨앗이 됩니다.<br class="d-none d-md-block">
					우리 이웃들에게 삶의 희망을 심어주세요.
                </p>
            </div>
        </div>
    </div>
    ...
    <!-- Content -->
	<main id="content" class="temporary-sponsor">
		<div class="container">
			<ul class="row">
