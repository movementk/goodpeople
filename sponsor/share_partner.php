...
<body class="sub sponsor">
    ...
    <!-- Content -->
    <main id="content" class="share-partner">
    	<div class="container">
    		<div class="page-intro">
    			<p>
    		...
    		<ul class="notify">
    			<li>
    				<dl>
    					<dt>사회공헌 캠페인</dt>
    					<dd>
    						굿피플은 기업과 함께 사회공헌캠페인(공익마케팅)을 펼칩니다.<br class="d-none d-md-block"> 파트너 기업의 특성에 맞는 사회공헌캠페인을 기획, 제공하며 함께 효과적인 운영을 통해 성공적인 캠페인 활동을 지원합니다.
    					</dd>
    				</dl>
    			</li>
    			<li>
    				<dl>
    					<dt>프로젝트 기금조성&#40;모금 / 물품&#41;</dt>
    					<dd>
    						굿피플은 진행중인 프로젝트별 기금조성을 기업과 함께합니다.<br class="d-none d-md-block"> 기업에 맞는 프로젝트를 선정, 기금을 조성하여 기업과 연계하여 지역개발에 기여하는 지원 방법입니다. 물품지원도 함께 이루어집니다.
    					</dd>
    				</dl>
    			</li>
    			<li>
    				<dl>
    					<dt>나눔파트너</dt>
    					<dd>
    						굿피플은 기업과 함께 나눔 캠페인, 임직원 자원봉사, 사업 후원, 국내‧해외 등 다양한 사회공헌활동을 진행하고 있습니다. 임직원들의 참여를 통한 나눔문화 확산, 기업의 긍정적인 이미지 구축 등 나눔을 통한 기쁨을 함께 느끼실 수 있습니다.
    					</dd>
    				</dl>
    			</li>
    			<li>
    				<dl>
    					<dt>나눔가게</dt>
    					<dd>
    						식당, 편의점, 약국, 은행 등 각 가게에 굿피플 모금함을 설치하여 어려운 이웃을 위한 나눔 활동에 동참하실 수 있습니다.
    					</dd>
    				</dl>
    			</li>
    		</ul>
    		...
    		<div class="tab-sponser">
				<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">분류 1</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">분류 2</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">분류 3</a>
					</li>
				</ul>
