...
<body class="sub sponsor">
    ...
    <div class="page-intro">
        <div class="container">
            ...
            <nav class="lnb">
                <ul class="tab-list">
                    <li class="active"><a href="/sponsor/partner_introduce.php">나눔파트너</a></li>
                    <li><a href="#">나눔가게</a></li>
                </ul>
            </nav>
        </div>
    ...
    <!-- Content -->
    <main id="content" class="partner-introduce">
    	<div class="container">
    		<div class="page-intro">
    			<p>
    			...
    			<figure>
    				<img src="/assets/images/sponser/img_partner_intro_sm.png" class="img-fluid" alt="">
    			</figure>
    		</div>
    		<ul class="notify">
    			<li>
    				<dl>
    					<dt>사회공헌 캠페인</dt>
    					<dd>
    						굿피플은 기업과 함께 사회공헌캠페인(공익마케팅)을 펼칩니다. 파트너 기업의 특성에 맞는 사회공헌캠페인을 기획, 제공하며 함께 효과적인 운영을 통해 성공적인 캠페인 활동을 지원합니다.
    					</dd>
    				</dl>
    			</li>
    			<li>
    				<dl>
    					...
    					<dd>
    						굿피플은 진행중인 프로젝트별 기금조성을 기업과 함께합니다. 기업에 맞는 프로젝트를 선정, 기금을 조성하여 기업과 연계하여 지역개발에 기여하는 지원 방법입니다. 물품지원도 함께 이루어집니다.
    					</dd>
    				</dl>
    			</li>
    			<li>
