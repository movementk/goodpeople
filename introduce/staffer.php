			...
			<section class="group">
				<div class="section-header">
					<nav class="sub-tab-list">
						<ul>
							<li><a href="/introduce/directors.php">이사장 및 회장</a></li>
							<li class="active"><a href="/introduce/staffer.php">사무국</a></li>
						</ul>
					</nav>
				</div>
				<div class="section-content">
					...
					<article class="gp-group">
						<div class="article-header">
							<h4>재무담당</h4>
							<p>후원자님이 보내주신 소중한 후원금을 운용 및 관리하고 있습니다. </p>
						</div>
						<div class="article-content">
							<ul>
								<li>
					...
					<article class="gp-group">
						<div class="article-header">
							<h4>국내담당</h4>
							<p>국내 소외된 아동, 노약자, 장애인, 노숙인 등을 대상으로 교육, 의료, 자활 등 다양한 사업을 시행하고 있습니다.</p>
						</div>
						<div class="article-content">
							<ul>
								<li>
					...
					<article class="gp-group">
						<div class="article-header">
							<h4>해외담당</h4>
							<p>지구촌 이웃들에게 삶의 희망을 심어주는 다양한 해외사업을 전개하고 있습니다.</p>
						</div>
						<div class="article-content">
							<ul>
								<li>
					...
					<article class="gp-group">
						<div class="article-header">
							<h4>사랑의의료봉사</h4>
							<p>지난 19년 동안 이동진료가 가능한 의료버스를 이끌고 의료 소외계층에게 사랑을 전하고 있습니다.</p>
						</div> 
						<div class="article-content">
							<ul>
								<li>
					...
					<article class="gp-group">
						<div class="article-header">
							<h4>총무담당</h4>
							<p>직원들이 안정적으로 일하도록 굿피플 안 살림을 담당하고 있습니다.</p>
						</div>
						<div class="article-content">
							<ul>
								<li>
					...
					<article class="gp-group">
						<div class="article-header">
							<h4>홍보담당</h4>
							<p>굿피플의 따끈따끈한 사업소식을 후원자님께 전하고 있습니다.</p>
						</div>
						<div class="article-content">
							<ul>
								<li>
					...
					<article class="gp-group">
						<div class="article-header">
							<h4>인사/기획담당</h4>
							<p>굿피플의 전체적인 방향성을 기획하고 관리하고 있습니다.</p>
						</div>
						<div class="article-content">
							<ul>
								<li>
					...
					<article class="gp-group">
						<div class="article-header">
							<h4>미디어팀</h4>
							<p>방송매체로 아이들과 후원자 사이의 징검검다리가 되어줍니다.</p>
						</div>
						<div class="article-content">
							<ul>
								<li>
					...
					<article class="gp-group">
						<div class="article-header">
							<h4>마케팅팀</h4>
							<p>톡톡 튀는 신선한 아이디어와 세상을 읽는 통찰력으로 사업 및 행사를 진행합니다.</p>
						</div>
						<div class="article-content">
							<ul>
								<li>
					...
					<article class="gp-group">
						<div class="article-header">
							<h4>복지법인</h4>
							<p>우리나라 사회복지의 증진을 통해 아동, 노인, 노숙인을 돕습니다.</p>
						</div>
						<div class="article-content">
							<ul>
								<li>
