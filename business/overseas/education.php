					...
					<div class="item">
						<div class="row">
							<div class="col-12 col-xl-6">
								<figure>   
									<img src="/assets/images/business/img_education_item01.jpg" class="img-fluid" alt="">
								</figure>
							</div>
							<div class="col-12 col-xl-6">
								<figure>
									<img src="/assets/images/business/img_education_item02.jpg" class="img-fluid" alt="">
								</figure>
							</div>
						</div>
					</div>
